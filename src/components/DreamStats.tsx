...
export default function DreamStats() {
  return (
    ...
    <div className="bg-gray-300 rounded-lg flex h-72 mt-4 flex-col items-center w-[500px] space-y-10 shadow-lg p-2">
        <h1 className="text-3xl font-bold text-gray-800 border-spacing-2 rounded-lg ">Dream Statics . . .🔮🦄</h1>
        <div className="flex space-x-12">
            <div title="Reactions count" className="text-center">
                <h2 className="text-4xl font-bold text-yellow-500 mb-2  hover:scale-110 ">125</h2>
